...
<body>
    ...
    <div id="navbar">
     ...
     <h1 class="text-center">Administration activity</h1>
            ...
            <?php 
                ...
                while($donnees=$reponse->fetch()){
                    echo "<tr>
                            ...
                            <td>
                                <form class='text-center' action='add_activity.php' method='POST'>
                                    <button class='btn btn-light' type='submit' name='add_activity'> + </button>
                                </form>
                                <form class='text-center' action='' method='POST'>
                                    <button class='btn btn-light' type='submit' name='delete_activity'> - </button>
                                </form>
                                <form class='text-center' action'' method='POST'>
                                    <button class='btn btn-light' type='submit' name='edit_activity'>edit</button>
                                </form>                            
                            </td>
                        </tr>";
                }
